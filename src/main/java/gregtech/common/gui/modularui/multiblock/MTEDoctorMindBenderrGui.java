...
public class MTEDoctorMindBenderrGui extends MTEMultiBlockBaseGui<MTEDoctorMindBender> {

    private final BigIntSyncValue ConsumptionSync = new BigIntSyncValue(
        multiblock::getTheoriticalEnergyConsumption,
        null);

    public MTEDoctorMindBenderrGui(MTEDoctorMindBender multiblock) {
        super(multiblock);
    }
    ...
    protected void registerSyncValues(PanelSyncManager syncManager) {
        ...
        syncManager.syncValue("finalConsumption", ConsumptionSync);
    }
    ...
    protected ListWidget<IWidget, ?> createTerminalTextWidget(PanelSyncManager syncManager, ModularPanel parent) {
        return super.createTerminalTextWidget(syncManager, parent).child(
            IKey.dynamic(
                () -> EnumChatFormatting.WHITE + "Energy used: " + toStandardForm(ConsumptionSync.getValue()) + "EU"
            // enabled if active
            )
                .asWidget()
                .setEnabledIf(
