...
public class MTEACALBioChamber extends MTEACALupgradeBase<MTEACALBioChamber>
    ...
    private static final IStructureDefinition<MTEACALBioChamber> STRUCTURE_DEFINITION = StructureDefinition
    ...
    public MTEACALBioChamber(String aName) {
        super(aName);
    }
    ...
    @Override
    public IStructureDefinition<MTEACALBioChamber> getStructureDefinition() {
    ...
    public IMetaTileEntity newMetaEntity(IGregTechTileEntity aTileEntity) {
        return new MTEACALBioChamber(this.mName);
    }
