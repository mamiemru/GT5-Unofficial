...
public abstract class MTEModuleBase<T extends MTEEnhancedMultiBlockBase<T>> extends MTEEnhancedMultiBlockBase<T> {
    ...
    public void unlinkController(MTEModulableController<?> oldController) {
    ...
    public void cancelRecipe(MTEModulableController<?> factory) {
    ...
    public void removeController(MTEModulableController<?> factory) {
    ...
    protected void runMachine(IGregTechTileEntity aBaseMetaTileEntity, long aTick) {
        MTEModulableController<?> factory = activeFactories.peek();
    ...
    public void addRecipe(MTEModulableController<?> factory) {
        IGregTechTileEntity baseFactory = factory.getBaseMetaTileEntity();
        for (MTEModulableController<?> listedFactory : activeFactories) {
